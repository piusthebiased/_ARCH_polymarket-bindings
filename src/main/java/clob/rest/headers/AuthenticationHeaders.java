...
public class AuthenticationHeaders {
    ...
    public static HeaderSet createL2Headers(KeyPair keys, APIKeyCredentials credentials, RequestArgs args) throws NoSuchAlgorithmException, InvalidKeyException {
        ...
        L2.addHeader("POLY_SIGNATURE", HMAC_SHA256.buildHMACSignature(credentials.secret, message));
        L2.addHeader("POLY_TIMESTAMP", timestamp);
        L2.addHeader("POLY_API_KEY", credentials.apiKey);
        L2.addHeader("POLY_PASSPHRASE", credentials.passphrase);
