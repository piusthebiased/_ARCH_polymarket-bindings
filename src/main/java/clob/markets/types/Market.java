...
//    public int compareTo(Market otherPerson) {
//        float thisRewards = this.rewards.rates[0].rewards_daily_rate;
//        float otherRewards = otherPerson.rewards.rates[0].rewards_daily_rate;
//
//        // this < other
//        if (thisRewards < otherRewards) {
//            return -1;
//        }
//
//        // this == other
