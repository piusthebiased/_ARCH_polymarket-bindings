...
configure_file(${CMAKE_CURRENT_SOURCE_DIR}/cfg/secp256k1_core.pc.in ${CMAKE_BINARY_DIR}/pkgconfig/secp256k1_core.pc @ONLY)
configure_file(${CMAKE_CURRENT_SOURCE_DIR}/cfg/secp256k1_jni.pc.in ${CMAKE_BINARY_DIR}/pkgconfig/secp256k1_jni.pc @ONLY)
...
install(
	FILES
	${CMAKE_BINARY_DIR}/pkgconfig/secp256k1_core.pc
	${CMAKE_BINARY_DIR}/pkgconfig/secp256k1_jni.pc
...
set(CPACK_PACKAGE_NAME secp256k1_java)
set(CPACK_PACKAGE_VERSION ${PROJECT_VERSION})
set(CPACK_PACKAGE_VENDOR "Eduard Maximovich")
set(CPACK_PACKAGE_CONTACT "edward.vstock@gmail.com")
set(CPACK_PACKAGE_HOMEPAGE_URL "https://github.com/edwardstock/native-secp256k1-java")
set(CPACK_PACKAGE_VCS_URL "https://github.com/edwardstock/native-secp256k1-java.git")
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY ${PROJECT_DESCRIPTION})
set(CPACK_RESOURCE_FILE_LICENSE "${CMAKE_CURRENT_SOURCE_DIR}/LICENSE")

if (NOT DISABLE_JNI)
	set(CPACK_RPM_PACKAGE_REQUIRES "java-1.8.0-openjdk-devel >= 1.8.0")
	set(CPACK_DEBIAN_PACKAGE_DEPENDS "default-jdk (>= 3.2.1)")
endif ()
