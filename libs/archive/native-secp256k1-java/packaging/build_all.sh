...
do
    ...
    $(docker exec ${vm_name} tar -zcvf ${buildRootPath}/libsecp256k1_${platform}.tar.gz ${buildRootPath}/libsecp256k1_core.a ${buildRootPath}/libsecp256k1_jni.so)
    builtPackage="${buildRootPath}/libsecp256k1_${platform}.tar.gz"
